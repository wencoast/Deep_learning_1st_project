...
def parse_args():
    ...
    parser.add_argument('--batch_normalization',type=bool,help='excute batch_normalization or not')
    # add argument for data_augmention with bool data type
    parser.add_argument('--data_augmention',type=bool,help='excute data augmention or not')
...
is_batch_normalization=tf.placeholder(tf.bool,name="is_batch_normalization")
