...
ax_loss.grid() 
for dropout in [0.5, 0.8, 0.9, 1.0]:
    plot_y_acc.clear()
    plot_y_loss.clear()
    # Construct model
    ...
    with tf.Session() as sess:
        ...
        ax_acc.plot(range(int(step-1)), plot_y_acc, label='keep_prob='+str(dropout))#/display_step
...
fig_acc.savefig("compare_keep_prob_acc.png")
